...
export const Head = () => <HeadComponent title='zajęcia' />;
        ...
        <GridSection isBig>
          <article>
            ...
            <ul>
              ...
              <li>
                <PyramidPointer />
                Czas poświecony na taniec brzucha przynosi nam wymierne korzyści zarówno dla ciała,
                psychiki i naszej duszy.
              </li>
            </ul>
          </article>
        ...
        <GridSection isBig>
          <article>
            ...
            <ul>
              ...
              <li>
                <PyramidPointer />
                pracując systematycznie nad zwiększeniem zakresu ruchu w stawach, siłą mięśni i ich
                rozciąganiem, utrzymaniem ładnej, wyprostowanej sylwetki nabierać gracji, elegancji
                w codziennym ruchu,
              </li>

              <li>
                <PyramidPointer />w sposób przyjemny pozbyć się zbędnych kilogramów - tańcząc w takt
                orientalnej muzyki spalamy ok. 500kc/h !
              </li>
            </ul>
          </article>
